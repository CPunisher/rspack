...
use rspack_fs_node::{AsyncNodeReadableFileSystem, AsyncNodeWritableFileSystem};

type CompilerInner =
  rspack_core::Compiler<AsyncNodeWritableFileSystem, AsyncNodeReadableFileSystem>;
